...
1. WP Immo Manager Logo
2. Custom Post Type "Immobilien" im Admin Dashboard.
3. Anzahl der aktiven Immobilien werden in Dashboard Übersicht angezeigt.
4. Admin-Einstellungen von WP Immo Manager
5. Synchronisationseinstellungen
6. XML-Einstellungen und Pfade
7. Post-Type Slug Einstellungen
8. Einstellungen der Single-Seite
9. Einstellungen der Übersichtsliste
10. Weitere Features wie Custom CSS, Top-Immobilie etc.
